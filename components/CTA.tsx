...
export default function CTA({
  ...
  return (
    <section className="relative overflow-hidden bg-brand-navy-dark py-16 sm:py-20 border-y border-slate-800">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          <div className="max-w-2xl space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 border border-white/20 rounded-full font-mono text-xs text-red-300">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 shrink-0">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-brand-accent hover:bg-brand-accent-hover text-white font-bold text-sm uppercase tracking-wider rounded-lg transition-all shadow-lg shadow-brand-accent/30 group"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-white hover:bg-slate-100 text-slate-900 font-bold text-sm uppercase tracking-wider rounded-lg transition-colors shadow-sm"
            >
