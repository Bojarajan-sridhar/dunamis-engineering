...
export default function DunamisPillars() {
  ...
  return (
    <section id="pillars-section" className="py-20 bg-[#F4F6FA] border-y border-slate-200 tech-grid-bg relative overflow-hidden scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200 bg-white shadow-2xl group">
          ...
          <div className="relative w-full aspect-[16/10] sm:aspect-[16/9] lg:aspect-[16/9] max-h-[620px] bg-slate-100">
            ...
            <div className="absolute top-3 sm:top-5 left-3 sm:left-5 z-10 flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/95 border border-slate-200 rounded-lg backdrop-blur-md shadow-md">
              <span className="w-2 h-2 rounded-full bg-brand-accent animate-pulse" />
              <span className="text-[11px] sm:text-xs font-mono font-bold text-slate-900 uppercase tracking-wider">
            ...
            <div className="absolute bottom-3 sm:bottom-6 left-3 sm:left-6 right-3 sm:right-6 z-10 p-4 sm:p-6 bg-white/95 border border-slate-200 rounded-xl sm:rounded-2xl shadow-xl backdrop-blur-md">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <h3 className="text-lg sm:text-xl font-black text-[#0B1A30] font-sans uppercase tracking-tight">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <Link
                    href="/about"
                    className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-slate-900 hover:bg-brand-accent text-white font-bold text-xs uppercase tracking-wider rounded-lg transition-colors shadow-sm"
                  >
                    <span>Our Story</span>
                  ...
                  <Link
                    href="/careers"
                    className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-brand-accent hover:bg-brand-accent-hover text-white font-bold text-xs uppercase tracking-wider rounded-lg transition-colors shadow-md"
                  >
