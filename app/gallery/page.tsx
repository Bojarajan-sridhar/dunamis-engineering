...
export default function GalleryPage() {
  ...
  return (
    <div className="pt-20 sm:pt-24 pb-16 sm:pb-20 space-y-14 sm:space-y-20 bg-pearl text-slate-900">
      {/* Page Header */}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Category Filters */}
        <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 pb-4 sm:pb-6 mb-8 sm:mb-10">
          {galleryCategories.map((cat) => (
            <button
              key={cat}
              onClick={() => setActiveCategory(cat)}
              className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-[11px] sm:text-xs font-mono font-bold uppercase tracking-wider transition-all ${
                activeCategory === cat
